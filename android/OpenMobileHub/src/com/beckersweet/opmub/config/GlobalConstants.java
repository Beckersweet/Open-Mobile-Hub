...
package com.beckersweet.opmub.config;

public class GlobalConstants {

	public static final String PYTHON_MAIN_SCRIPT_NAME = "ppserver_driver2.py";
	public static final String PYTHON_PROJECT_ZIP_NAME = "ppserver_driver2.py.zip";
	public static final String PYTHON_ZIP_NAME = "python_27.zip";
	public static final String PYTHON_EXTRAS_ZIP_NAME = "python_extras_27_2.zip";
